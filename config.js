...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'DELBOY ANIEY-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'DELBOY' : process.env.OWNER_NAME,
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'bales,supemarket,vanodabasa,' : process.env.ANTI_BAD_WORD,
